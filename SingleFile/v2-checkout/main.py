...
class UI:
        ...
        ">
            ...
            <div style="text-align: center;">
                <div style="
                    ...
                    justify-content: center;
                    margin: 0 auto 15px auto;
                    box-shadow: 0 8px 25px rgba(165, 94, 234, 0.2);
                ">
    ...
    def render_products(products: List[Product], on_add_to_cart, on_back):
        ...
        for i, p in enumerate(products):
            badge_html = ""
            if p.badge:
                badge_class = f"badge-{p.badge.lower()}"
                badge_html = f"""
                <div style="
                    position: absolute;
                    top: 15px;
                ...
                ">
                    ...
                    ">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <div>
                                <p style="color: #2d3436; font-weight: 600; margin: 0;">Credit Card</p>
                                <p style="color: #666; font-size: 12px; margin: 0;">Coming soon</p>
                            </div>
                        </div>
                    </div>
                    ...
                    ">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <i class="fas fa-mobile-alt" style="font-size: 24px; color: #e84393;"></i>
                            <div>
                                <p style="color: #2d3436; font-weight: 600; margin: 0;">Mobile Wallet</p>
                                <p style="color: #666; font-size: 12px; margin: 0;">Coming soon</p>
                            </div>
                        </div>
                    </div>
